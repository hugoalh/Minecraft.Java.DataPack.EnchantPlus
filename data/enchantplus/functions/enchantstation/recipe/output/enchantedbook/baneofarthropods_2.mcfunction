...
execute if score @s enchantplus_ref = If_EnchantedBook_AddOn enchantplus_ref run data modify block ~ ~-1 ~ Items[{Slot:4b}].tag.StoredEnchantments append value {id:"minecraft:bane_of_arthropods",lvl:2s}
...
execute if score @s enchantplus_ref = If_Item_AddOn enchantplus_ref run data modify block ~ ~-1 ~ Items[{Slot:4b}].tag.Enchantments append value {id:"minecraft:bane_of_arthropods",lvl:2s}
