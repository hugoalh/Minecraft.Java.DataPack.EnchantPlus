...
execute if data block ~ ~-1 ~ Items[{Slot:4b,id:"minecraft:enchanted_book",tag:{StoredEnchantments:[{id:"minecraft:respiration",lvl:2s}]}}] run scoreboard players operation @s enchantplus_ref = If_Invalid enchantplus_ref
...
execute if data block ~ ~-1 ~ Items[{Slot:4b,tag:{Enchantments:[{id:"minecraft:respiration",lvl:2s}]}}] run scoreboard players operation @s enchantplus_ref = If_Invalid enchantplus_ref
