...
execute if data block ~ ~-1 ~ Items[{Slot:4b,id:"minecraft:enchanted_book",tag:{StoredEnchantments:[{id:"minecraft:bane_of_arthropods",lvl:2s}]}}] run scoreboard players operation @s enchantplus_ref = If_EnchantedBook_Useless enchantplus_ref
...
execute if data block ~ ~-1 ~ Items[{Slot:4b,tag:{Enchantments:[{id:"minecraft:bane_of_arthropods",lvl:2s}]}}] run scoreboard players operation @s enchantplus_ref = If_Item_Useless enchantplus_ref
