...
execute if score @s enchantplus_ref = If_EnchantedBook_AddOn enchantplus_ref run data modify block ~ ~-1 ~ Items[{Slot:4b}].tag.StoredEnchantments append value {id:"minecraft:bane_of_arthropods",lvl:4s}
...
execute if score @s enchantplus_ref = If_EnchantedBook_Upgrade enchantplus_ref run data modify block ~ ~-1 ~ Items[{Slot:4b}].tag.StoredEnchantments[{id:"minecraft:bane_of_arthropods"}].lvl set value 4s
execute if score @s enchantplus_ref = If_Item_AddOn enchantplus_ref run data modify block ~ ~-1 ~ Items[{Slot:4b}].tag.Enchantments append value {id:"minecraft:bane_of_arthropods",lvl:4s}
...
execute if score @s enchantplus_ref = If_Item_Upgrade enchantplus_ref run data modify block ~ ~-1 ~ Items[{Slot:4b}].tag.Enchantments[{id:"minecraft:bane_of_arthropods"}].lvl set value 4s
